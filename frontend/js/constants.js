const contractAddress = "0x4635789D03a959942F5B017B7D61B0488745b0E9"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the MummyApeNFT!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The MummyApeNFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
const h1_presale_coming_soon = "MummyApeNFT Coming Soon!!";
